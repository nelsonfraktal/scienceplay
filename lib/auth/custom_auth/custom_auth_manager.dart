...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    sciencePlayAppAuthUserSubject.add(
      SciencePlayAppAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<SciencePlayAppAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  SciencePlayAppAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = SciencePlayAppAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    sciencePlayAppAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
SciencePlayAppAuthUser? currentUser;
