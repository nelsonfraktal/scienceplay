...
import 'top_premium_content_model.dart';
export 'top_premium_content_model.dart';

class TopPremiumContentWidget extends StatefulWidget {
  const TopPremiumContentWidget({
    super.key,
  ...
  @override
  State<TopPremiumContentWidget> createState() =>
      _TopPremiumContentWidgetState();
}

class _TopPremiumContentWidgetState extends State<TopPremiumContentWidget> {
  late TopPremiumContentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TopPremiumContentModel());
  }
            ...
            children: [
              ...
              Flexible(
                child: Padding(
                  ...
                  child: Builder(
                    builder: (context) {
                      final content = widget.contents!.toList();
