...
import 'component_report_transcription_model.dart';
export 'component_report_transcription_model.dart';

class ComponentReportTranscriptionWidget extends StatefulWidget {
  const ComponentReportTranscriptionWidget({
    super.key,
  ...
  @override
  State<ComponentReportTranscriptionWidget> createState() =>
      _ComponentReportTranscriptionWidgetState();
}

class _ComponentReportTranscriptionWidgetState
    extends State<ComponentReportTranscriptionWidget> {
  late ComponentReportTranscriptionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComponentReportTranscriptionModel());
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    FFLocalizations.of(context).getText(
                      'jipksjzx' /* What's your concern with this ... */,
                    ),
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          fontFamily: 'Poppins',
                            ...
                            child: Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'lg1lsqea' /* The transcription is incorrect */,
                                    ),
                            ...
                            child: Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'r9vj4xg2' /* The transcription isn't in syn... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'z3n35yln' /* It's the wrong transcript */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                            ...
                            child: Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'doix414v' /* My concern isn't here */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: FFLocalizations.of(context).getText(
                              'g4k1m0ly' /* Please describe what's happeni... */,
                            ),
