...
import 'premium_student_model.dart';
export 'premium_student_model.dart';

class PremiumStudentWidget extends StatefulWidget {
  const PremiumStudentWidget({super.key});

  @override
  State<PremiumStudentWidget> createState() => _PremiumStudentWidgetState();
}

class _PremiumStudentWidgetState extends State<PremiumStudentWidget> {
  late PremiumStudentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PremiumStudentModel());
  }
        ...
        body: Container(
          ...
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
              fit: BoxFit.cover,
              image: Image.asset(
                'assets/images/cheerful-young-doctor-with-tablet-hall_2_(1).png',
              ).image,
            ),
          ),
          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Flexible(
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'zl03w5gn' /* Over 100 health & medicin cont... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Flexible(
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'rrovgltv' /* Unlimited access to all paid c... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Flexible(
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'zg19tpvs' /* Early access to new content */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                    ...
                                    onTap: () async {
                                      ...
                                      if (_model.mensalSelecionado) {
                                        if (FFLocalizations.of(context)
                                            ...
                                            'pt') {
                                          await launchURL(
                                              'https://pay.hotmart.com/Q94182288K?off=bbv3amca');
                                        } else {
                                          await launchURL(
                                              'https://pay.hotmart.com/Q94182288K?off=m76m1fg6');
                                        }
                                      } else {
                                        if (FFLocalizations.of(context)
                                                .languageCode ==
                                            'pt') {
                                          await launchURL(
                                              'https://pay.hotmart.com/Q94182288K?off=xtoii31z');
                                        } else {
                                          await launchURL(
                                              'https://pay.hotmart.com/Q94182288K?off=y587ezna');
                                        }
                                      }
                                    },
                                    child: Container(
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'qib2zclh' /* The subscription will automati... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
