...
class TrackModel extends FlutterFlowModel<TrackWidget> {
  ...
  // Stores action output result for [Backend Call - API (iniciouUmaPlaylist)] action in Icon widget.
  ApiCallResponse? apiResultIniciouPlaylist1;
  // Stores action output result for [Backend Call - API (iniciouUmaPlaylist)] action in ContainerCellAudio widget.
  ApiCallResponse? apiResultIniciouPlaylist2;
